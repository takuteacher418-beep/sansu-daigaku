  ...
  problems: [
    {
      ...
      formulaCards: ["合計", "÷", "個数", "＝", "平均"],
      smallSteps: [
        { prompt: "何について説明する問題ですか。", type: "choice", options: ["平均", "最大の数", "合計"], correct: "平均", support: "問題文の最初の言葉に注目しよう。" },
        { prompt: "平均は、数をどのようにした数ですか。", type: "choice", options: ["同じくらいにならした", "大きい順に並べた", "全部かけた"], correct: "同じくらいにならした", support: "8、4、6を6、6、6にする図を見てみよう。" },
        { prompt: "ここまでの言葉を使って、説明を完成させよう。", type: "template", fields: ["平均とは", "数です。"], expected: ["ならした"] }
      ]
    },
    {
      ...
      formulaCards: ["5", "＋", "7", "＋", "9", "＝", "21", "÷", "3", "＝", "7"],
      smallSteps: [
        { prompt: "平均を求めるために、最初にすることはどれですか。", type: "choice", options: ["全部を足す", "一番大きい数を選ぶ", "全部をかける"], correct: "全部を足す", support: "5、7、9を一つの量にまとめます。" },
        { prompt: "全部を足す式をカードで作ろう。", type: "formula", target: "5＋7＋9＝21", cards: ["5", "＋", "7", "＋", "9", "＝", "21"] },
        { prompt: "合計21を、数の個数3で割る式を作ろう。", type: "formula", target: "21÷3＝7", cards: ["21", "÷", "3", "＝", "7"] },
        { prompt: "式と言葉を使って、求め方を説明しよう。", type: "template", fields: ["まず", "次に", "だから平均は"], expected: ["21", "3", "7"] }
      ]
    },
    {
      ...
      formulaCards: ["比べる量", "÷", "もとにする量", "＝", "割合"],
      smallSteps: [
        { prompt: "割合では、何と何を比べますか。", type: "choice", options: ["比べる量ともとにする量", "答えと式", "たし算とかけ算"], correct: "比べる量ともとにする量", support: "名前に『比べる』『もと』が入っています。" },
        { prompt: "割合を求める関係をカードで作ろう。", type: "formula", target: "比べる量÷もとにする量＝割合", cards: ["比べる量", "÷", "もとにする量", "＝", "割合"] },
        { prompt: "割合の意味を説明しよう。", type: "template", fields: ["割合とは、比べる量が", "の何倍かを表す数です。"], expected: ["もとにする量"] }
      ]
    }
  ]
};
